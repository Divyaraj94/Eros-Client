...
const Info = () => {
    ...
    if (navigator.geolocation) {
      navigator.geolocation.getCurrentPosition(
        async (position) => {
          ...
          // Call API to get address and validate pincode
  ...
  const validateLocation = async (lat, lng) => {
    try {
      ...
      if (data.success) {
        return data.pincode; // Return pincode if valid
      }
      return false;
    } catch (error) {
  ...
  return (
    <div className="next-section-wrapper">
      ...
      <div className="next-section-heading">
        ...
        <p>Since 1990, we’ve been crafting the finest sweet and savory delights, made with love and authentic recipes passed down through generations.</p>
      </div>
      ...
      <div className="next-section-features">
        <div className="feature-column">
          <div className="feature-card">
            ...
            <p>Our recipes are rooted in rich culinary traditions, made using the finest ingredients to bring you a taste of heritage.</p>
          </div>
          <div className="feature-card">
            <h3>Unmatched Quality</h3>
            <p>We believe in delivering only the finest, from premium ingredients to hygienic preparation.</p>
          </div>
        </div>
        ...
        <div className="feature-column">
          <div className="feature-card">
            ...
            <p>Every sweet and namkeen is a labor of love, ensuring freshness and authenticity in every bite.</p>
          </div>
          <div className="feature-card">
            <h3>Joy for Every Budget</h3>
            <p>From festive boxes to everyday snacks, our treats are thoughtfully priced for everyone to enjoy.</p>
          </div>
        </div>
      </div>
